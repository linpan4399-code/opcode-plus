...
export const api = {
   ...
   */
  async executeClaudeCode(projectPath: string, prompt: string, model: string, effort?: string): Promise<void> {
    return apiCall("execute_claude_code", { projectPath, prompt, model, effort });
  },
   ...
   */
  async resumeClaudeCode(projectPath: string, sessionId: string, prompt: string, model: string, effort?: string): Promise<void> {
    return apiCall("resume_claude_code", { projectPath, sessionId, prompt, model, effort });
  },
