...
export const Settings: React.FC<SettingsProps> = ({
  ...
  const saveSettings = async () => {
    try {
      ...
      setToast({ message: t("toast.settingsSaved"), type: "success" });
    } catch (err) {
      console.error("Failed to save settings:", err);
      setError(t("toast.settingsFailed"));
      setToast({ message: t("toast.settingsFailed"), type: "error" });
    } finally {
      setSaving(false);
    }
  };
                  ...
                  <div className="space-y-4">
                    ...
                    {theme === 'custom' && (
                      <div className="space-y-4 p-4 border rounded-lg bg-muted/20">
                        <h4 className="text-label">{t("settings.general.customTheme")}</h4>

                        <div className="grid grid-cols-2 gap-4">
                          {/* Background Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-background" className="text-caption">{t("settings.general.background")}</Label>
                          ...
                          {/* Foreground Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-foreground" className="text-caption">{t("settings.general.foreground")}</Label>
                            <div className="flex gap-2">
                              <Input
                                id="color-foreground"
                                type="text"
                          ...
                          {/* Primary Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-primary" className="text-caption">{t("settings.general.primary")}</Label>
                            <div className="flex gap-2">
                              <Input
                                id="color-primary"
                                type="text"
                          ...
                          {/* Card Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-card" className="text-caption">{t("settings.general.card")}</Label>
                            <div className="flex gap-2">
                              <Input
                                id="color-card"
                                type="text"
                          ...
                          {/* Accent Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-accent" className="text-caption">{t("settings.general.accent")}</Label>
                            <div className="flex gap-2">
                              <Input
                                id="color-accent"
                                type="text"
                          ...
                          {/* Destructive Color */}
                          <div className="space-y-2">
                            <Label htmlFor="color-destructive" className="text-caption">{t("settings.general.destructive")}</Label>
                            <div className="flex gap-2">
                              <Input
                        ...
                        <p className="text-caption text-muted-foreground">
                          {t("settings.general.customThemeHint")}
                        </p>
                      </div>
                    )}
                        ...
                        <div className="flex gap-2">
                          ...
                          <div className="space-y-1">
                            ...
                            <ul className="text-xs text-muted-foreground space-y-0.5">
                              <li>• {t("settings.general.privacyPoints.noPersonal")}</li>
                              <li>• {t("settings.general.privacyPoints.anonymous")}</li>
                              <li>• {t("settings.general.privacyPoints.disable")}</li>
                            </ul>
                          </div>
                        </div>
                      </div>
                ...
                <div className="space-y-6">
                  ...
                  <div className="pt-2 space-y-2">
                    ...
                    <ul className="text-caption text-muted-foreground space-y-1 ml-4">
                      <li>• <code className="px-1 py-0.5 rounded bg-green-500/10 text-green-600 dark:text-green-400">Bash</code> - {t("settings.permissions.examplesList.bash")}</li>
                      <li>• <code className="px-1 py-0.5 rounded bg-green-500/10 text-green-600 dark:text-green-400">Bash(npm run build)</code> - {t("settings.permissions.examplesList.bashExact")}</li>
                      <li>• <code className="px-1 py-0.5 rounded bg-green-500/10 text-green-600 dark:text-green-400">Bash(npm run test:*)</code> - {t("settings.permissions.examplesList.bashPrefix")}</li>
                      <li>• <code className="px-1 py-0.5 rounded bg-green-500/10 text-green-600 dark:text-green-400">Read(~/.zshrc)</code> - {t("settings.permissions.examplesList.read")}</li>
                      <li>• <code className="px-1 py-0.5 rounded bg-green-500/10 text-green-600 dark:text-green-400">Edit(docs/**)</code> - {t("settings.permissions.examplesList.edit")}</li>
                    </ul>
                  </div>
                </div>
              </Card>
            ...
            <TabsContent value="environment" className="space-y-6">
              <Card className="p-6">
                <div className="space-y-6">
                  ...
                  <div className="pt-2 space-y-2">
                    <p className="text-xs text-muted-foreground">
                      <strong>{t("settings.environment.common")}</strong>
                    </p>
                    <ul className="text-caption text-muted-foreground space-y-1 ml-4">
                      <li>• <code className="px-1 py-0.5 rounded bg-blue-500/10 text-blue-600 dark:text-blue-400">CLAUDE_CODE_ENABLE_TELEMETRY</code> - {t("settings.environment.commonList.telemetry")}</li>
                      <li>• <code className="px-1 py-0.5 rounded bg-blue-500/10 text-blue-600 dark:text-blue-400">ANTHROPIC_MODEL</code> - {t("settings.environment.commonList.model")}</li>
                      <li>• <code className="px-1 py-0.5 rounded bg-blue-500/10 text-blue-600 dark:text-blue-400">DISABLE_COST_WARNINGS</code> - {t("settings.environment.commonList.costWarnings")}</li>
                    </ul>
                  </div>
                </div>
              </Card>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-body-small text-muted-foreground mb-4">
                      ...
                      {t("settings.hooks.storedIn")} <code className="mx-1 px-2 py-1 bg-muted rounded text-xs">~/.claude/settings.json</code>
                    </p>
                  </div>
